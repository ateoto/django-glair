...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Album.is_private'
        db.add_column(u'glair_album', 'is_private',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

        # Adding field 'Photo.is_private'
        db.add_column(u'glair_photo', 'is_private',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Album.is_private'
        db.delete_column(u'glair_album', 'is_private')

        # Deleting field 'Photo.is_private'
        db.delete_column(u'glair_photo', 'is_private')
    ...
    models = {
        ...
        u'glair.photo': {
            ...
            'manufacturer': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['glair.Manufacturer']", 'null': 'True'}),
            'name': ('django.db.models.fields.CharField', [], {'max_length': '200'}),
            'owner': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['auth.User']"}),
            'slug': ('django.db.models.fields.SlugField', [], {'max_length': '50'}),
