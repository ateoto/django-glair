...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column(u'glair_photo', 'manufacturer',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['glair.Manufacturer'], null=True),
                      keep_default=False)
    ...
    def backwards(self, orm):
        ...
        # Deleting field 'Photo.manufacturer'
        db.delete_column(u'glair_photo', 'manufacturer_id')
